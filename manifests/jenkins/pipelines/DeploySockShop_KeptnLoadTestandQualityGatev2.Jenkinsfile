                ...
                //container('kubectl'){
                    ...
                    script{
                        ...
                        //container('kubectl'){
                            ...
                            cartsIp = sh (returnStdout:true, script:"./kubectl get ingress dev-ingress -n dev  | grep -o carts.dev.*io,").trim()
        ...
        stage ('Run Load Test'){
            steps{
                script{
                    ...
                    def keptnContext = keptn.sendDeploymentFinishedEvent testStrategy:"performance", deploymentURI: "http://${cartsIp}" 
